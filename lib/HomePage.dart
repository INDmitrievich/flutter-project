    ...
    return Scaffold(
      body: Stack(
        children: [
          Column(
            ...
            children: [
              AppBar(
                ...
                elevation: 0,
                title: Text("Рабочее просторанство", style: TextStyle(
                    fontSize: 30
                ),),
                actions: [
                  IconButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        InkWell(
                          onTap: (){changeFilter("Месяцы");},
                          child: Text("Месяцы", style: TextStyle(
                              color: Colors.white,
                              fontSize: 18
                          ),),
                        ),
                        ...
                        Container(
                          height: 4,
                          width: 120,
                          color: (filterType == "Месяцы")?Colors.white:Colors.transparent,
                        )
                      ],
                    )
                  ],
              ...
              (filterType == "Месяцы")?TableCalendar(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      taskWidget(Color(0xfff96060), "Встреча с кем-либо" , "9:00 AM"),
                      taskWidget(Colors.blue, "Встреча с кем-либо" , "9:00 AM"),
                      taskWidget(Colors.green, "Принять лекарства" , "9:00 AM"),
                    ],
                  ),
                ),
              ),
                            ...
                            Container(
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(height: 5,),
                                  Text("Мои задания", style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 15
                                  ),)
                                ],
          ...
          Container(
            child: (taskPop == "Открыть") ? Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: openNewTask,
                          child: Container(
                            child: Text("Добавить задание", style: TextStyle(
                                fontSize: 18
                            ),),
                          ),
                        ),
                        ...
                        InkWell(
                          ...
                          child: Container(
                            child: Text("Добавить контрольный список", style: TextStyle(
                                fontSize: 18
                            ),),
                          ),
                        ),
