...
import 'package:new_list/HomePage.dart';
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Новый список", style: TextStyle(
            fontSize: 25
        ),),
        leading: IconButton(
          icon: Icon(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10,),
                            Text("Обязательно напиши здесь о задании", style: TextStyle(
                                  fontSize: 18
                            ),),
                            ...
                            Container(
                              ...
                              child: Center(
                                child: Text("Добавить список", style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 18
                                ),),
                              ),
