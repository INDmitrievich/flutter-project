    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          Text("Поздровляю!", style: TextStyle(
              fontSize: 35
          ),),
          Text("Вы успешно изменили ваш паррль, впредь попросим вас не забывать его, теперь вы можете спокойно войти в систему с помощью нового пароля!", style: TextStyle(
            fontSize: 18,
